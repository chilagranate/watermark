...
def iniciar_servidor(host: str = "0.0.0.0", port: int = 8765):
    ip = _get_local_ip()
    url = f"http://{ip}:{port}"
    print(f"\n{'='*50}")
    ...
    try:
        ...
        use_webview = False
        print("  pywebview no instalado, usando navegador\n")
